...
const dictionaries = {
  en: {
    ...
    'filters.orderDefault': 'Default',
    'filters.orderPriceAsc': 'Price: low to high',
    'filters.orderPriceDesc': 'Price: high to low',
    'filters.orderDiscountAsc': 'Discount: low to high',
    'filters.orderDiscountDesc': 'Discount: high to low',
    'filters.orderEndingSoon': 'Ending soon',
    'filters.orderNewest': 'Newest',
    'filters.orderTitleAsc': 'Title: A to Z',
    'filters.orderTitleDesc': 'Title: Z to A',
    ...
    'product.hurryUp': 'Hurry up',
    'product.wootOff': 'Woot Off',
  ...
  es: {
    ...
    'filters.orderBy': 'Ordenar por',
    'filters.orderDefault': 'Predeterminado',
    'filters.orderPriceAsc': 'Precio: menor a mayor',
    'filters.orderPriceDesc': 'Precio: mayor a menor',
    'filters.orderDiscountAsc': 'Descuento: menor a mayor',
    'filters.orderDiscountDesc': 'Descuento: mayor a menor',
    'filters.orderEndingSoon': 'Próximas a vencer',
    'filters.orderNewest': 'Más recientes',
    'filters.orderTitleAsc': 'Título: A a Z',
    'filters.orderTitleDesc': 'Título: Z a A',
